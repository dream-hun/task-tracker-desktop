...
test('tasks can be searched by title and description', function () {
    $user = User::factory()->create();
...
test('the task list summarizes the tasks of the user', function () {
    $user = User::factory()->create();
...
test('unfinished tasks are listed before completed ones', function () {
    $user = User::factory()->create();
...
test('the task list is paginated', function () {
    $user = User::factory()->create();
